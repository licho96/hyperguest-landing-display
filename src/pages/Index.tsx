              ...
              <div className="space-y-16">
                {[
                  ...
                  <div key={index} className="flex flex-col md:flex-row items-start gap-8 relative">
                    <div className="md:w-12 md:h-12 bg-primary text-white rounded-full flex items-center justify-center text-primary font-bold text-lg relative z-10 shadow-lg shadow-primary/20">
                      {index + 1}
                    </div>
